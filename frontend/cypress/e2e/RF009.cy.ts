...
describe('Login Page', () => {
	...
	it('[RF009] Deve excluir a carteira', () => {
		...
		cy.get('[data-testid="data-table-row-actions__dropdown__delete-button"]').click({ force: true })

		cy.get('[data-testid="modal-excluir-carteira__dialog-content__checkbox"]').click()

		cy.get('[data-testid="modal-excluir-carteira__dialog-footer__delete-button"]').click()
